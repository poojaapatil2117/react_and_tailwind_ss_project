...
import { Caption, ProfileCard, Title ,PrimaryButton} from "../common/Design";
                ...
                <div className="h-56 relative overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 p-2 w-full">
                        <div className="flex items-center justify-between">
                            ...
                            <Caption className="text-green bg-green_100 px-3 py-1 text-sm rounded-full">{item?.totalBids} 20</Caption>
                        </div>
                    </div>
                </div>
